...
<head>
    ...
    <link rel="stylesheet" href="css/index_driver.css">
...
<table style="position:relative; left:30px;">
    ...
    <tr>
        <td>
            ...
            <img src="{{ asset('archivos/'. $dato->picrep) }}" class="card-img-top" alt="...">
            <div class="card-body">
            ...
            <div class="card-body">
                <a href="{{ route('editar', ['id' => $dato->id]) }}" class="card-link">Editar información</a>
